...
namespace BookingApp.Admin.Controllers
{
    ...
    public class CollaboratorController : Controller
    {
        ...
        private readonly AppService<BookingInformation, BookingInformationViewModel> _bookingInformationService;
        ...
        public CollaboratorController(IMapper mapper, ApplicationDbContext context, IImageService imageService, ICollaboratorService collaboratorService)
        {
            ...
            _bookingInformationService = new AppService<BookingInformation, BookingInformationViewModel>(mapper, context);
