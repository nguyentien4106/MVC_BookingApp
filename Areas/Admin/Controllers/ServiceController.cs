...
namespace BookingApp.Areas.Admin.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create(BookingApp.Entities.Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, BookingApp.Entities.Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
